  ...
  return (
    <div className="flex flex-col leading-none">
      <div className={`flex items-center ${s.gap}`}>
        ...
        />
        <span
          className={`font-inter font-bold tracking-wide leading-none whitespace-nowrap ${s.wordMark}`}
      ...
      {showTagline && (
        <span className={`font-dm font-medium text-[var(--c-subtle)] mt-1.5 tracking-widest uppercase ${s.tag}`}>
